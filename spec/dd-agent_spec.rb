...
shared_examples_for 'rhellions repo' do
  ...
  it 'downloads and imports the new RPM key' do
    expect(chef_run).to create_remote_file('DATADOG_RPM_KEY.e09422b3.public').with(path: '/var/chef/cache/DATADOG_RPM_KEY.e09422b3.public')
    expect(chef_run).to run_execute('rpm-import datadog key e09422b3').with(
      command: 'rpm --import /var/chef/cache/DATADOG_RPM_KEY.e09422b3.public'
    )
  end
